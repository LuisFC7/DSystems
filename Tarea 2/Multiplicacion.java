...
public class Multiplicacion {
    ...
    private static int N = 3000; // Tamaño de las matrices
    ...
    private static class ClientHandler implements Runnable {
        ...
        public void run() {
            try {
                ...
                System.out.println("Las matrices han sido recibidas correctamente.");
                // imprimir(Aaux);
                ...
                System.out.println("Enviando matrices...");
    ...
    public static void main(String[] args) {
        ...
        if (nodo == 0) {
           ...
           // String[] direccionesIP = { "localhost", "localhost", "localhost" };
            String[] direccionesIP = { "172.173.236.212", "52.255.151.158", "20.10.159.103" };
            ...
            for (int i = 0; i < N; i++) {
                for (int j = 0; j < N; j++) {
                    A[i][j] = 2 * i + j;
                    B[i][j] = 3 * i - j;
                    Bori[i][j] = 3 * i - j;// Esta matriz solo se usa para impresión
                }
            }
            ...
            try {
                ...
                System.out.println("Checksum de matriz C: ");
