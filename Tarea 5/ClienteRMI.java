...
public class ClienteRMI {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Se llamama al archivo InterfaceRMI
            ...
            h2.join();
            // // Crear matriz Caux
            // float[][][] Caux = new float[81][subN][subN];
            ...
            imprimirMatriz(BT);
            System.out.println("Submatrices de A:");
            imprimirSubmatrices(subA);
            System.out.println("Submatrices de BT:");
            imprimirSubmatrices(subBT);
            System.out.println("Matriz Final");
            imprimirSubmatrices3D(Caux);
            System.out.println("Checksum: " + Checksum());

            // System.out.println(servidor.impt(subA[1], subN, M));
            float[][] prueba1 = new float[N / 9][N / 9];
            prueba1 = servidor.multiplicarMatrices(subA[0], subBT[0], subN, M);
            imprimirMatriz(prueba1);
